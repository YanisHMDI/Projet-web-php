...
$route['playlist/add_album_to_playlist/(:num)/(:num)'] = 'playlist/add_album_to_playlist/$1/$2';
$route['playlist/add_track_to_playlist/(:num)/(:num)'] = 'playlist/add_track_to_playlist/$1/$2';
